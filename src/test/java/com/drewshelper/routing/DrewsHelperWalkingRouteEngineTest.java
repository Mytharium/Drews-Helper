...
public class DrewsHelperWalkingRouteEngineTest
{
    ...
    public void matchesLiveClientForkTowardSoutheastWaypoints() throws Exception
    {
        ...
        assertEquals("path " + southernRoute.getPath(), 38, southernRoute.getWalkingDistance());
        assertEquals(Arrays.asList(
            ...
            new WorldPoint(2951, 3208, 0)
        ), southernRoute.getPath());
    }

    @Test
    public void matchesLiveReverseFaladorSoutheastTreeLineRoute() throws Exception
    {
        DrewsHelperWalkingRouteEngine engine = new DrewsHelperWalkingRouteEngine(DrewsHelperCollisionMap.loadDefault());

        DrewsHelperRouteSnapshot route = engine.solve(
            new WorldPoint(2951, 3208, 0),
            Collections.singletonList(new WorldPoint(2942, 3243, 0))
        );

        assertEquals(DrewsHelperRouteStatus.READY, route.getStatus());
        assertEquals("path " + route.getPath(), 38, route.getWalkingDistance());
        assertEquals(Arrays.asList(
            new WorldPoint(2951, 3208, 0),
    ...
    @Test
    public void matchesLiveEastPressureFaladorSoutheastTreeLineRoute() throws Exception
    {
        DrewsHelperWalkingRouteEngine engine = new DrewsHelperWalkingRouteEngine(DrewsHelperCollisionMap.loadDefault());
        ...
        assertEquals(DrewsHelperRouteStatus.READY, route.getStatus());
        assertEquals("path " + route.getPath(), 34, route.getWalkingDistance());
        assertEquals(Arrays.asList(
            new WorldPoint(2946, 3239, 0),
            new WorldPoint(2946, 3238, 0),
            new WorldPoint(2946, 3237, 0),
